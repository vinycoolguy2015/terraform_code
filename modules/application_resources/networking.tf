...
resource "aws_internet_gateway" "internet_gateway" {
  ...
  tags = {
    Name = join("_", [local.vpc_name, "internet_gateway"])
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = join("_", [local.vpc_name, "public_route_table"])
  }
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = join("_", [local.vpc_name, "private_route_table"])
  }
...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    Name = join("_", [local.vpc_name, "public_subnet", count.index + 1])
  }
  lifecycle {
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    Name = join("_", [local.vpc_name, "private_subnet", count.index + 1])
  }
  lifecycle {
    ignore_changes = [availability_zone]
  }
...
resource "aws_nat_gateway" "vpc_nat_gateway" {
  ...
  tags = {
    Name = join("_", [local.vpc_name, "nat_gateway"])
  }
}
...
resource "aws_default_network_acl" "default" {
  ...
  tags = {
    Name = join("_", [local.vpc_name, "default_nacl"])
  }
}
